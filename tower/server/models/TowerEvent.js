...
export const TowerEventSchema = new Schema(
    {
        ...
        coverImg: {type:String, maxlength: 500, minlength: 3, default:'https://wallpapercave.com/wp/wp7126218.jpg'},
        location: {type:String, required:true, maxlength: 100, minlength: 2},
        capacity: {type:Number, required:true, minimum: 5, maximum:200000},
